...
document.getElementById('canvas').addEventListener('click', event.closeContextMenu); // Menu
...
document.getElementById('menu-delete').addEventListener('click', event.onMenuDelete); // Create icon modal
...
document.getElementById('text-input').addEventListener('input', event.onTextInputChange); // Search
