...
let map = new Map([new Marker('person', '1', 'I am message', '', {
  ...
  x: 300,
  y: 300
}, [])], [new Page('1', 'Stardew valley', [new Floor('1', 'Floor 1', img1, null), new Floor('2', 'Floor 2', img2, null)]), new Page('2', 'Valley of mines', [new Floor('3', 'Floor 1', img1, null), new Floor('4', 'Floor 2', img2, null)])]);
global.setMap(map);